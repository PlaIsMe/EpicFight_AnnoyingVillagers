...
import com.pla.epicfight_annoyingvillagers.combatbehaviour.HerobrineDemoniacVoltageReaver;
...
import com.pla.epicfight_annoyingvillagers.gameasset.AnimsEpicFightValourGuard;
...
public class SwordsmanHerobrinePatch extends CEHumanoidPatch<PathfinderMob> implements CustomExecuteEntity {
    ...
    public void playGuardHitAnimation(DamageSource damageSource, boolean canCounter) {
        if (ModList.get().isLoaded("efn") && this.getOriginal() instanceof HerobrineMob herobrineMob && herobrineMob.getLivingEntityPatch() != null) {
            EpicFightNightFallUtil.playEfnGuardHit(herobrineMob.getLivingEntityPatch(), herobrineMob.getEfnGuardHitState(), damageSource);
