...
import com.pla.epicfight_annoyingvillagers.compat.dualaxes.AvNpcDualAxe;
import com.pla.epicfight_annoyingvillagers.compat.dualgreatsword.AvNpcDualGreatsword;
import com.pla.epicfight_annoyingvillagers.compat.epicfightx.*;
import com.pla.epicfight_annoyingvillagers.config.AnnoyingVillagersConfig;
import com.pla.epicfight_annoyingvillagers.entity.GreenVillagerKnightEntity;
import com.pla.epicfight_annoyingvillagers.gameasset.AnimsWom;
import com.pla.epicfight_annoyingvillagers.util.MobPatchCommon;
...
public class VillagerKnightPatch extends CEHumanoidPatch<PathfinderMob> implements CustomExecuteEntity {
    ...
    protected void setWeaponMotions() {
        ...
        if (!ModList.get().isLoaded("epicfightx")) {
            ...
            this.weaponAttackMotions
                    .put(WeaponCategories.FIST,
                            ImmutableMap.of(Styles.COMMON, AvNpcXFist.X_FIST));
            this.weaponAttackMotions
                    .put(WeaponCategories.SWORD,
                            ImmutableMap.of(
                                    Styles.ONE_HAND, AvNpcXSword.X_SWORD,
                                    Styles.TWO_HAND, AvNpcXSword.X_DUAL_SWORD
                            ));

            this.weaponAttackMotions
                    .put(WeaponCategories.DAGGER,
                            ImmutableMap.of(
                                    Styles.ONE_HAND, AvNpcXDagger.X_DAGGER,
                                    Styles.TWO_HAND, AvNpcXDagger.X_DUAL_DAGGER
                            ));

            this.weaponAttackMotions
                    .put(WeaponCategories.UCHIGATANA,
                            ImmutableMap.of(
                                    Styles.TWO_HAND, AvNpcXUchigatana.X_UCHIGATANA
                            ));
            this.weaponAttackMotions
                    .put(WeaponCategories.SPEAR,
                            ImmutableMap.of(
                                    Styles.ONE_HAND, AvNpcXSpear.X_SPEAR_SHIELD,
                                    Styles.TWO_HAND, AvNpcXSpear.X_SPEAR
                            ));

            this.weaponAttackMotions
                    .put(WeaponCategories.LONGSWORD,
                            ImmutableMap.of(
                                    Styles.ONE_HAND, AvNpcXLongsword.X_LONGSWORD_SHIELD,
                                    Styles.TWO_HAND, AvNpcXLongsword.X_LONGSWORD
                            ));

            this.weaponAttackMotions
                    .put(WeaponCategories.TACHI,
                            ImmutableMap.of(
                                    Styles.TWO_HAND, AvNpcXTachi.X_TACHI
                            ));
        }
        ...
        if (ModList.get().isLoaded("epicfightx")) {
            weaponAttackMotions
                    .put(WeaponCategories.AXE,
                            ImmutableMap.of(
                                    Styles.ONE_HAND, AvNpcXAxe.X_AXE)
                    );
        } else if (ModList.get().isLoaded("dualaxes")) {
            weaponAttackMotions
                    .put(WeaponCategories.AXE,
                            ImmutableMap.of(
                                    Styles.ONE_HAND, AvNpcDualAxe.AXE,
                                    Styles.TWO_HAND, AvNpcDualAxe.DUAL_AXE)
                    );
        } else {
            this.weaponAttackMotions
                    .put(WeaponCategories.AXE,
        ...
        if (ModList.get().isLoaded("epicfightx")) {
            weaponAttackMotions
                    .put(WeaponCategories.GREATSWORD,
                            ImmutableMap.of(
                                    Styles.TWO_HAND, AvNpcXGreatsword.X_GREATSWORD));
        } else if (ModList.get().isLoaded("dualgreatswords")) {
            weaponAttackMotions
                    .put(WeaponCategories.GREATSWORD,
                            ImmutableMap.of(
                                    Styles.TWO_HAND, AvNpcGreatsword.GREATSWORD,
                                    Styles.OCHS, AvNpcDualGreatsword.DUAL_GREATSWORD));
        } else {
            this.weaponAttackMotions
                    .put(WeaponCategories.GREATSWORD,
        ...
        if (ModList.get().isLoaded("dualgreatswords")) {
            guardHitMotions.put(WeaponCategories.GREATSWORD,
                    ImmutableMap.of(
                            Styles.TWO_HAND, List.of(
    ...
    public void playGuardHitAnimation(DamageSource damageSource, boolean canCounter) {
        if (ModList.get().isLoaded("efn") && this.getOriginal() instanceof GreenVillagerKnightEntity greenVillagerKnightEntity && greenVillagerKnightEntity.getLivingEntityPatch() != null) {
            EpicFightNightFallUtil.playEfnGuardHit(greenVillagerKnightEntity.getLivingEntityPatch(), greenVillagerKnightEntity.getEfnGuardHitState(), damageSource);
    ...
    public boolean dealStaminaDamage(DamageSource damageSource, float amount) {
        if (ModList.get().isLoaded("efn") && EpicFightNightFallUtil.isPlayingEfnGuardHit(this)) {
            return false;
        } else {
