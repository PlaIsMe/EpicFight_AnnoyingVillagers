...
public final class AvNpcAnimationCompat {
    ...
    public static void stopEatingAnimation(AVNpc playerNpc) {
        ...
        if (patch != null && animation != null) {
            ...
            if (AVAnimations.EAT_OFFHAND != null) patch.stopPlaying(AVAnimations.EAT_OFFHAND);
    ...
    public static void updateClientEatingAnimation(LivingEntityPatch<?> patch, boolean eating) {
        ...
        if (!eating) {
            stopClientEatingClip(animator, AVAnimations.EAT_MAINHAND);
            stopClientEatingClip(animator, AVAnimations.EAT_OFFHAND);
            return;
        }
    ...
    static AssetAccessor<? extends StaticAnimation> diggingAnimation() {
        AssetAccessor<? extends StaticAnimation> animation = AVAnimations.DIG_MAINHAND;
    ...
    static AssetAccessor<? extends StaticAnimation> mainHandUseAnimation() {
        AssetAccessor<? extends StaticAnimation> animation = AVAnimations.USE_MAINHAND;
    ...
    static AssetAccessor<? extends StaticAnimation> eatingAnimation() {
        AssetAccessor<? extends StaticAnimation> animation = AVAnimations.EAT_MAINHAND;
    ...
    private static AssetAccessor<? extends StaticAnimation> eatingAnimation(AVNpc npc) {
        return npc.isUsingItem() && npc.getUsedItemHand() == net.minecraft.world.InteractionHand.OFF_HAND
                && isEatingAnimationUsable(AVAnimations.EAT_OFFHAND)
                ? AVAnimations.EAT_OFFHAND : eatingAnimation();
    }
