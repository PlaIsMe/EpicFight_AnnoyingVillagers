...
public final class WeaponCapabilityPresetTracking {
    ...
    private static final ConcurrentMap<Object, Function<Item, ? extends CapabilityItem.Builder<?>>> PRESETS =
    ...
    public static CapabilityItem.Builder<?> recordBuilder(
            CapabilityItem.Builder<?> builder, Function<Item, ? extends CapabilityItem.Builder<?>> preset) {
    ...
    public static void recordBuiltCapability(CapabilityItem.Builder builder, CapabilityItem capability) {
        Function<Item, ? extends CapabilityItem.Builder<?>> preset = PRESETS.get(builder);
        if (preset != null) {
    ...
    public static Function<Item, ? extends CapabilityItem.Builder<?>> getPreset(CapabilityItem capability) {
